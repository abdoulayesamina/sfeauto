/**
 * Compresse une image côté client en utilisant un Canvas.
 ...
 * @returns Une Promise résolue avec le fichier compressé (format JPEG).
 */
    ...
    return new Promise((resolve, reject) => {
        ...
        reader.onload = (event) => {
            ...
            img.onload = () => {
                ...
                // Calculer les nouvelles dimensions tout en conservant l'aspect ratio
                if (width > height) {
                    if (width > maxWidth) {
