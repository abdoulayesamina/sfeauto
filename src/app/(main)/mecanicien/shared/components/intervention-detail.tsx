  ...
  return (
    <div className="space-y-6 md:w-[600px]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <p className="text-sm">
                {selectedIntervention?.accordNumber}
            </p>

            <p className="text-xs text-gray-500 mt-1">
                Confirmé le{" "}
                {new Date(selectedIntervention?.dateOfConfirmation)
            ...
            <div className="flex items-center gap-3 mb-1">
                ...
                {React.createElement(
                    getStatusMeta(selectedIntervention?.status).icon,
                    { size: 20 }
                )}
                </div>
            ...
            <p className="text-xs text-gray-500 mt-1">
                Mis à jour le{" "}
                {new Date(selectedIntervention?.statusUpdatedAt)
        ...
        <div className="rounded-xl border p-4 bg-zinc-50">
            ...
            <p className="text-sm">
            Créé le{" "}
            {new Date(selectedIntervention?.createdAt)
                .toLocaleDateString("fr-FR")}
            </p>
