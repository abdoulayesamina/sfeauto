...
CREATE TABLE `vehicle_veh` (
    ...
    `veh_kilometrage` VARCHAR(191) NULL,
    ...
    INDEX `vehicle_veh_veh_brandId_fkey`(`veh_brandId`),
    INDEX `vehicle_veh_veh_modelId_fkey`(`veh_modelId`),
    PRIMARY KEY (`veh_id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `intervention_int` (
    ...
    `int_status` ENUM('WAITING_FOR_PARTS', 'FIXING_STARTED', 'FIXING_FINISHED') NOT NULL DEFAULT 'FIXING_STARTED',
    ...
    `int_kilometrage` VARCHAR(191) NULL,
    `int_supprimee` BOOLEAN NOT NULL DEFAULT false,
    `int_baseId` VARCHAR(191) NULL,
    `int_clientId` VARCHAR(191) NULL,
    ...
    INDEX `intervention_int_int_supprimee_idx`(`int_supprimee`),
    INDEX `intervention_int_int_clientId_idx`(`int_clientId`),
    INDEX `intervention_int_int_baseId_idx`(`int_baseId`),
    PRIMARY KEY (`int_id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `interventionphoto_itp` (
    ...
    INDEX `interventionphoto_itp_itp_uploadedById_fkey`(`itp_uploadedById`),
    PRIMARY KEY (`itp_id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `statushistory_sth` (
    ...
    `sth_previousStatus` ENUM('WAITING_FOR_PARTS', 'FIXING_STARTED', 'FIXING_FINISHED') NOT NULL,
    `sth_newStatus` ENUM('WAITING_FOR_PARTS', 'FIXING_STARTED', 'FIXING_FINISHED') NOT NULL,
...
CREATE TABLE `changehistory_chg` (
    ...
    INDEX `changehistory_chg_chg_changedBy_fkey`(`chg_changedBy`),
    PRIMARY KEY (`chg_id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `user_usr` (
    ...
    INDEX `user_usr_usr_baseId_fkey`(`usr_baseId`),
    INDEX `user_usr_usr_clientId_fkey`(`usr_clientId`),
    PRIMARY KEY (`usr_id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `model_mod` (
    ...
    INDEX `model_mod_mod_brandId_fkey`(`mod_brandId`),
